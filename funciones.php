							  ...
							  <div class="panel panel-default col-md-3">
							   ...
							   <div class="panel panel-default col-md-3">
									<ul class="nav nav-pills nav-stacked">
									  ...
									  <li role="presentation"><a href="#"><button type="button" class="btn btn-default btn-circle botonAzul"><i class="glyphicon glyphicon-pencil textoBoton"></i></button> 13:00</a></li>
									  <li class="opcionSeleccionada"><a href="#"><button type="button" class="btn btn-default btn-circle botonAzul"><i  class="glyphicon glyphicon-pencil textoBoton" ></i></button> 15:00</i></a></li>
										<li class="opcionSeleccionada"><a href="#"><button type="button" class="btn btn-default btn-circle botonAzul"><i class="glyphicon glyphicon-pencil textoBoton"></i></button> 17:00</a></li>
