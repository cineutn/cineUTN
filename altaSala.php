...
<div class="modal fade" id="noDiagramarSala" tabindex="-1" role="dialog" aria-labelledby="modalLoginLabel">
	<div class="modal-dialog"  role="document">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
		  	...
		  	<div class="modal-body">  
                    <input type='hidden' id='idSalaEliminar' value=""></input>
                    <span>La sala posee funciones activas, no se puede cambiar el diagrama.</span></br>                    
		  	</div>
      	  <div class="modal-footer">				
				<button  class="btn btn-default" data-dismiss="modal">Aceptar</button>
		  	</div>
