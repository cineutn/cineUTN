 ...
 ?>
       ...
       <div class="row paginaCompra">
           <form class="col-md-7" id="frmBuscarVenta">
                    ...
                    <div class="form-group">
                      	<button type="button" name="btnBuscarVenta" id="btnBuscarVenta" class="btn btn-primary pull-right">
            ...
            <div class="container">
				...
				<div id="tablaResumenCompra" class="row">
					<table class="table table-condensed"> 
						...
						<button type="button" name="btnImprimir" id="btnImprimir" class="btn btn-primary pull-right">
